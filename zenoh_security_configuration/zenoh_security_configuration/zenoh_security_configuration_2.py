...
def main(argv=sys.argv):
    ...
    # print(conf.get_json('access_control/enabled'))
    # print(conf.get_json('access_control/default_permission'))
    # print(conf.get_json('access_control/rules'))
    # conf.insert_json5('access_control/enabled', 'true')
    # conf.insert_json5('access_control/default_permission', "'deny'")
    ...
    # for enclaves in root.iter('enclaves'):
    #     for enclave in enclaves.iter('enclave'):
    #         for profiles in enclaves.iter('profiles'):
    #             for profile in profiles.iter('profile'):
    #                 for services in profile.iter('services'):
    #                     for service in profile.iter('service'):
    #                         if services.attrib['reply'] == 'ALLOW':
    #                             services_reply_allow.add(service.text)
    #                         if services.attrib['reply'] == 'DENY':
    #                             services_reply_deny.add(service.text)
    #                 for topics in profile.iter('topics'):
    #                     for topic in topics.iter('topic'):
    #                         topic_type = list(topics.attrib.keys())[0]
    ...
    # print('services_reply_allow: ', services_reply_allow)
    # print('services_reply_deny: ', services_reply_deny)
    # print('topics_pub_allow: ', topics_pub_allow)
    # print('topics_pub_deny: ', topics_pub_deny)
    # print('topics_sub_allow: ', topics_sub_allow)
    # print('topics_sub_deny: ', topics_sub_deny)
